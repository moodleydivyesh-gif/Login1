...
assertEquals("ID: "+ msg2.getMessageID()+ "| Hash: " + msg2.getMessageHash()+ " | Recipient: " + msg2.getRecipient()+ " | Message: " + msg2.getMessageText(),longest,"Message 2 is the longest stored message.");
